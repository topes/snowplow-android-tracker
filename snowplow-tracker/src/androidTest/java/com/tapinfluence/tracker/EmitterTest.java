...
package com.tapinfluence.tracker;
...
import com.tapinfluence.tracker.emitter.ReadyRequest;
import com.tapinfluence.tracker.emitter.RequestCallback;
import com.tapinfluence.tracker.emitter.RequestSecurity;
import com.tapinfluence.tracker.payload.Payload;
import com.tapinfluence.tracker.payload.TrackerPayload;
import com.tapinfluence.tracker.storage.EventStore;
import com.tapinfluence.tracker.emitter.RequestResult;
import com.tapinfluence.tracker.emitter.EmittableEvents;
...
public class EmitterTest extends AndroidTestCase {
    ...
    public void testCallbackSet() {
        Emitter emitter = new Emitter.EmitterBuilder(getContext()).callback(new RequestCallback() {
            @Override
    ...
    public void testUpdatingEmitterSettings() throws InterruptedException, IOException, JSONException {
        MockWebServer mockServer = getMockServer();
        Emitter emitter = new Emitter.EmitterBuilder(getContext())
    ...
    public void testBuildingOversizeEvents() throws InterruptedException, IOException, JSONException {
        ...
        emitter = new Emitter.EmitterBuilder(getContext())
    ...
    public Emitter getEmitter(String uri, HttpMethod method, BufferOption option, RequestSecurity security) {
        return new Emitter.EmitterBuilder(getContext())
                .option(option)
                .method(method)
                .security(security)
                .tick(0)
