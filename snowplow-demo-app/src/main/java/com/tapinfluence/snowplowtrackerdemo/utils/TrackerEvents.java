...
package com.tapinfluence.snowplowtrackerdemo.utils;

import com.tapinfluence.tracker.Tracker;
import com.tapinfluence.tracker.events.EcommerceTransaction;
import com.tapinfluence.tracker.events.EcommerceTransactionItem;
import com.tapinfluence.tracker.events.PageView;
import com.tapinfluence.tracker.events.ScreenView;
import com.tapinfluence.tracker.events.SelfDescribing;
import com.tapinfluence.tracker.events.Structured;
import com.tapinfluence.tracker.events.Timing;
...
public class TrackerEvents {
    ...
    private static void trackPageView(com.tapinfluence.tracker.Tracker tracker) {
    ...
    private static void trackStructuredEvent(com.tapinfluence.tracker.Tracker tracker) {
    ...
    private static void trackScreenView(com.tapinfluence.tracker.Tracker tracker) {
    ...
    private static void trackTimings(com.tapinfluence.tracker.Tracker tracker) {
    ...
    private static void trackUnstructuredEvent(com.tapinfluence.tracker.Tracker tracker) {
    ...
    private static void trackEcommerceEvent(com.tapinfluence.tracker.Tracker tracker) {
